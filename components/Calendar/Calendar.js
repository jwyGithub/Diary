...
Component({
	...
	lifetimes: {
		attached() {
			this.setData({
				nowYear: getDate(new Date(), 'yyyy'),
				nowMonth: getDate(new Date(), 'MM'),
				nowDay: getDate(new Date(), 'yyyy-MM-dd'),
				headerDate: getDate(new Date(), 'yyyy/MM/dd'),
				headerDay: getDate(new Date(), 'd'),
				headerWeek: weekFormat(getDate(new Date(), 'w')),
	...
	methods: {
		...
		changeDate(e) {
			if (e.currentTarget.dataset.date) {
				this.setData({
					nowDay: getDate(new Date(`${this.data.nowYear}-${this.data.nowMonth}-${e.currentTarget.dataset.date}`), 'yyyy-MM-d')
				})
			}
